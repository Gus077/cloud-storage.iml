...
public class MainController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // не понимаю как можно указать путь иначе, если пишу просто "server", то не получается подняться на папку выше.
        serverDirectory = new File("D:\\Java dropbox\\cloud-storage-feb-3-master\\server");
